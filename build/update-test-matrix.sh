...
test_matrix=(
    ...
    # "test_ipv4_only              v1.13                       "
    # "test_ipv6_only              v1.13                       "
    # "test_ipv6_only_nat64        v1.13                       "
    # "test_ipv6_only_ext_aaaa     v1.13                       "
    # "test_dual_stack_v4_svc_net  v1.13                       "
    # "test_src_release"
    # "test_src_master"
)
...
function test_name {
  local test_name k8s_ver cni cri
  read test_name k8s_ver cni cri <<<"$1"
